...
/**
 * @visibleName Moving-Average-Stamp
 */
const MovingAverageStamp = ({ value, data, isNoData }) => {
  return (
    <Stamp title="Moving Average">
      <Body>
        {isNoData ? (
          <NoData />
        ) : (
          <>
            ...
            <LineChart>
              <Chart data={data} title="Movinge Average Stamp" />
              <ChartSegment>
                <ChartBackground />
...
MovingAverageStamp.defaultProps = {
  isNoData: false
};

MovingAverageStamp.propTypes = {
  value: PropTypes.number.isRequired,
  data: PropTypes.array.isRequired,
  isNoData: PropTypes.bool
};

export default MovingAverageStamp;
